...
2. Начать собирать quality-оценки после каждого использования (цель: ≥ 10 оценок на роль)
3. Применить deprecation process хотя бы один раз (или задокументировать что не применимо)
4. Настроить push-trigger CI для push в main (сейчас только PR-trigger)
