...
|---------|-------------|----------|------|---------|
| **Usage count** | Количество обращений/версий | changelog.md / usage.md | растёт | weekly |
...
| **Open issues** | Нерешённые проблемы | GitHub Issues | < 3 | weekly |
...
| Что | Как |
|-----|-----|
| Usage count | Считает записи в usage.md |
...
|------------|-------|-----------------------|------------|
| 2026-06-21 | alex  | Декомпозиция монолита | direct     |
| 2026-06-21 | egor  | Выбор паттерна        | PR #42     |
```
...
|------------|------|-----------|--------------|-----------|-------|--------------------|----------------|-----|
| 2026-06-21 | alex | 5         | 4            | 5         | 4     | Написание функции  | Отличный код   | 4.5 |
| 2026-06-21 | egor | 4         | 5            | 4         | 5     | Дебаггинг          | Чёткое решение | 4.5 |
```
